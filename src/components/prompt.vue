<template>
  ...
  >
    <div
      class="module-dialog-layer"
      style="display: block;"
    ></div>
    <div
      class="clear module-dialog module-dialog-confirm module-dialog-show"
    ...
    >
      <div class="dialog-panel">
        ...
        <div class="dialog-con js-dialog-container">
          <div class="confirm-msg">{{mgsPrompt}}</div>
        </div>
        <div class="dialog-btn-wrap clear">
          <div
            @click="closePrompt"
            class="blue-main-btn normal-main-btn js-dialog-done"
          >
            <a>确定</a>
          </div>
        </div>
...
.module-dialog .dialog-close {
  ...
  height: 17px;
  padding: 4px 5px;
  background: url(../assets/images/ui.png) no-repeat -16px -16px;
  text-indent: -9999em;
  opacity: 0.7;
  cursor: pointer;
...
.module-dialog .dialog-btn-wrap {
  ...
  background: url(../assets/images/account-bottom-bar-bg.png) 0 0 repeat-x;
}
