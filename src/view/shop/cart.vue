                  ...
                  <div class="cart-items">
                    ...
                    <div class="name hide-row">
                      <div class="name-table">
                        ...
                        <ul class="attribute">
                          <li
                            v-for="(item,index) in item.spec_json"
                            :key="index"
                          >{{item.show_name}}</li>
                        </ul>
                      </div>
                    ...
                    <div class="item-cols-num">
                      <div class="select js-select-quantity">
                        <span
                          ...
                          @click="subCount(item.sku_id)"
                        >-</span>
                        <span class="num">{{item.count}}</span>
                        <span
                          class="up"
                          :class="{'up-disabled':item.count>=item.limit_num}"
                          @click="addCount(item.sku_id)"
                        >+</span>
                      </div>
                    </div>
...
.cart-box .empty-label {
  height: 49px;
  padding: 385px 0 0 0;
  background: url(../../assets/images/cart-box-empty.png) no-repeat center 50px;
  text-align: center;
}
...
.cart-box .blue-checkbox-new {
  ...
  width: 20px;
  height: 20px;
  background: url(../../assets/images/checkbox-new.png) no-repeat 0 -20px;
  cursor: pointer;
  vertical-align: middle;
}
.cart-box .checkbox-on {
  background: url(../../assets/images/checkbox-new.png) no-repeat 0 0;
}
...
.hander-car .cart-items .operation .items-delete-btn {
  ...
  margin: 0 auto;
  color: #c2c2c2;
  background: url(../../assets/images/delete-btn-icon.jpg);
...
.select .up {
  ...
  width: 36px;
  height: 36px;
  background: url(../../assets/images/cart-updown.jpg) no-repeat;
  background-image: url(../../assets/images/cart-updown.jpg);
  background-size: 100% auto;
  line-height: 40px;
  text-indent: -9999em;
  cursor: pointer;
